...
cc.Class({
    ...
    onLoad () {
        ...
        function loadImgByUrl( remoteUrl, imageType) {
            ...
            cc.loader.load({
                ...
                require("Scripts").ChangeSizeByNode(self.node._components[1].Bins[self.player.getComponent("Move").lrstate]._parent,self.Red)
            });
        }
        
        
        loadImgByUrl("https://www1.forwhat01.top/others/sfylc_resource/draw/General/sprcls2_boxred.png",null)
    ...
    update (dt) {
        ...
        if (this.RedCount >= 6){//红色箱子达到一定数目就可判断是否胜利，结束游戏
            ...
            var wl = this.node.children[4].getComponent("WinOrLose")
        ...
        else if (this.RedCount >= 2 && this.Warn[this.RedCount - 2].active) {
